...
Motivations to use Value Stream Mapping in your Technology teams
...
- Reduce delays and re-work caused by missing information

But why would you need Value Stream Mapping?

- You need multiple teams to ship something (design, devs, product, operations, etc)
- You care if the customer is happy to pay for what you shipped
- You need to see the flow of work across teams
- Where are the obstacles to flow, and exaclty what problems are they causing?
- How should we prioritize improvements? Why? 
- Value Stream Mapping helps you see obstacles, prioritize and align
